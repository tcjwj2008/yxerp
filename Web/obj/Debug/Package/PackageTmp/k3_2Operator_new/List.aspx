<%@ Page Title="k3_2Operator_new" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="yinxiang.Web.k3_2Operator_new.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="OperatorName" HeaderText="OperatorName" SortExpression="OperatorName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PassWord" HeaderText="PassWord" SortExpression="PassWord" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="IsAdmin" HeaderText="IsAdmin" SortExpression="IsAdmin" ItemStyle-HorizontalAlign="Center"  /> 
